# Public Disclosure: Technical Status & R&D Phase
*(Česká verze následuje níže)*

**Date:** February 8, 2026  
**Project Stage:** Technical Genesis / Internal R&D  
**Entity:** Tenis Dubeč s.r.o. (ID: 23653281)

## 1. Nature of Current Activities
The TIGR token and its associated smart contracts are operating in a **restricted Research & Development (R&D) mode**.  
No public‑facing services, financial utilities, or services regulated as virtual asset‑related (VAM) activities are active.  
The purpose of this phase is to validate governance logic, smart contract behavior, and the technical architecture on the Solana blockchain under controlled conditions.

## 2. Market Activity and Liquidity
All current blockchain activity — including initial liquidity provisioning and internal test transactions — is conducted exclusively by the founding entity.

- **Internal Bootstrapping Only:** These actions are strictly technical in nature.  
- **No Public Offering:** TIGR tokens have not been offered, marketed, sold, or distributed to the public. The project has not been marketed as an investment opportunity, and no communication has been directed toward public token distribution. The sharing of technical information, such as the contract address (CA), has occurred solely in the context of transparency and was not associated with any call to purchase or investment solicitation.  
...
**“Integrity is the foundation of our architecture. Code is its guardian.”**
...
Token TIGR a související smart kontrakty fungují v **omezeném režimu výzkumu a vývoje (R&D)**.  
Nejsou aktivní žádné veřejně dostupné služby, finanční funkce ani služby regulované jako činnosti spojené s virtuálními aktivy (VAM).  
Cílem této fáze je ověřit logiku governance, chování smart kontraktů a technickou architekturu na blockchainu Solana za kontrolovaných podmínek.

## 2. Tržní aktivita a likvidita
Veškerá současná blockchainová aktivita — včetně počátečního poskytnutí likvidity a interních testovacích transakcí — je prováděna výhradně zakládající entitou.

- **Pouze interní bootstrap:** Tyto úkony mají čistě technický charakter.  
- **Žádná veřejná nabídka:** Tokeny TIGR nebyly veřejně nabízeny, propagovány, prodávány ani distribuovány. Projekt nebyl nikde marketingově propagován jako investiční příležitost a žádná komunikace nebyla zaměřena na veřejnou distribuci tokenů. Sdílení technických informací, jako je contract address (CA), proběhlo výhradně v kontextu transparentnosti a nebylo spojeno s výzvou k nákupu či investiční pobídkou. 
...
**„Integrita je základem naší architektury. Kód je jejím strážcem.“**
